      ...
      <section>
        ...
        <main>
          ...
          >
            ...
            <Card.Body>
              <Card.Title>Ítalo Bonilha</Card.Title>
              <Card.Text>italo zika</Card.Text>
              ...
              <Card.Text>[1] Nome: Rex, Raça: Raçudo, Tipo: Ódio, Genero: Destruição</Card.Text>
            </Card.Body>
          </Card>
        </main>
      </section>
